    ...
    <div id="example">
      <div id="slides">
        <div class="slides_container">
          ...
          <?php _e(' <div class="slide"><a href="#" target="_blank" title="GO Link"><img src="'.get_stylesheet_directory_uri().'/images/IMG_3879.png" width="950" height="300" title="F.P.H shooting grass" alt="F.P.H shooting grass"></a>
            <div class="caption" style="bottom:0"> <span>F.P.H shooting grass</span> </div>
          </div>
          <div class="slide"><a href="#" target="_blank" title="GO Link"><img src="'.get_stylesheet_directory_uri().'/images/IMG_4182.png" width="950" height="300" title="F.P.H shooting cat" alt="F.P.H shooting cat"></a>
